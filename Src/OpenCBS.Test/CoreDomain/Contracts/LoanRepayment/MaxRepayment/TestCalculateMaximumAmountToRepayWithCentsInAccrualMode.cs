...
namespace OpenCBS.Test.CoreDomain.Contracts.LoanRepayment.MaxRepayment
{
    ...
    /// </summary>
    [TestFixture]
    public class TestCalculateMaximumAmountToRepayWithCents
    {
        ...
        public void CalculateMaximumAmount_Flat_BadLoan_42dayslate_OLB_KeepNotExpectedInstallment()
        {
            ...
            //Without CALCULATION_LATE_FEES_DURING_PUBLIC_HOLIDAYS:
            // 1000 + 60 + (1000 * 42 * 0.003) + 800 * 0.01 => 1194 
            //Assert.AreEqual(1194, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));

            //With CALCULATION_LATE_FEES_DURING_PUBLIC_HOLIDAYS:
            // Excluding 7 days: 3 holidays (1/1/2006, 6/1/2006, 8/3/2006) and 4 weekends
            // 1000 + 60 + (1000 * 35 * 0.003) + 800 * 0.01 => 1173
            Assert.AreEqual(1173, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
        }
        ...
        public void CalculateMaximumAmount_Flat_BadLoan_42dayslate_OverDuePrincipal_KeepNotExpectedInstallment()
        {
            ...
            Assert.AreEqual(1076.4m, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
            ...
            Assert.AreEqual(1074.6m, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
        ...
        public void CalculateMaximumAmount_Flat_BadLoan_42dayslate_OverDuePrincipalAndInterest_KeepNotExpectedInstallment()
        {
            ...
            Assert.AreEqual(1081.44m, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
            ...
            Assert.AreEqual(1078.74m, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
        ...
        public void CalculateMaximumAmount_Declining_BadLoan_42dayslate_InitialAmount_KeepNotExpectedInstallment()
        {
            ...
            Assert.AreEqual(1194.12m, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
        }
        ...
        public void CalculateMaximumAmount_Declining_BadLoan_42dayslate_OverDuePrincipal_KeepNotExpectedInstallment()
        {
            ...
            Assert.AreEqual(1076.03m, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
            
            //NOT CALCULATION_LATE_FEES_DURING_PUBLIC_HOLIDAYS
            ApplicationSettings.GetInstance("").UpdateParameter("CALCULATION_LATE_FEES_DURING_PUBLIC_HOLIDAYS", false);            

            Assert.AreEqual(1074.34m, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
        ...
        public void CalculateMaximumAmount_Declining_BadLoan_42dayslate_OverDuePrincipalAndInterest_KeepNotExpectedInstallment()
        {
            ...
            Assert.AreEqual(1081.07m, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
            //NOT CALCULATION_LATE_FEES_DURING_PUBLIC_HOLIDAYS
            ApplicationSettings.GetInstance("").UpdateParameter("CALCULATION_LATE_FEES_DURING_PUBLIC_HOLIDAYS", false);            

            Assert.AreEqual(1078.48m, Math.Round(mAR.CalculateMaximumAmountAuthorizedToRepay(new DateTime(2006, 3, 15)).Value, 2));
        ...
        private static CalculateMaximumAmountToRepayStrategy _MaximumAmountToRepay(Loan pContract, bool pCancelFees, 
            OCurrency pManualFeesAmount, OCurrency pManualCommissionAmount, bool pCancelInterest, OCurrency pManualInterestAmount)
        {
            var cCO = new CreditContractOptions(pContract.Product.LoanType, pContract.Product.KeepExpectedInstallment, 
                pCancelFees, pManualFeesAmount, pManualCommissionAmount, pCancelInterest, pManualInterestAmount, 
                pContract.Product.AnticipatedTotalRepaymentPenaltiesBase);

            return new CalculateMaximumAmountToRepayStrategy(cCO, pContract, new User(), ApplicationSettings.GetInstance(""), 
