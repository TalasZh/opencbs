...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_LoanRepaymentEvents_ContractEvents]') AND parent_object_id = OBJECT_ID(N'[dbo].[LoanRepaymentEvents]'))
ALTER TABLE [dbo].[LoanRepaymentEvents] DROP CONSTRAINT [FK_LoanRepaymentEvents_ContractEvents]
GO
...
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LoanRepaymentEvents]') AND type in (N'U'))
DROP TABLE [dbo].[LoanRepaymentEvents]
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LoanRepaymentEvents]') AND type in (N'U'))
BEGIN
...
CREATE TABLE [dbo].[ContractEvents](
	...
	[repayment_type] [nvarchar](20) NULL,
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_LoanRepaymentEvents_ContractEvents]') AND parent_object_id = OBJECT_ID(N'[dbo].[LoanRepaymentEvents]'))
ALTER TABLE [dbo].[LoanRepaymentEvents]  WITH CHECK ADD  CONSTRAINT [FK_LoanRepaymentEvents_ContractEvents] FOREIGN KEY([id])
REFERENCES [dbo].[ContractEvents] ([id])
GO
