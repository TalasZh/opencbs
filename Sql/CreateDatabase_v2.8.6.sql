...
CREATE TABLE [dbo].[Packages](
	...
	[activated_loc] BIT DEFAULT ((0)) NOT NULL,
...
CREATE TABLE [dbo].[ContractEvents](
    ...
    [entry_date] [datetime] DEFAULT(GETDATE()) NULL
...
CREATE TABLE [dbo].[Credit](
	...
	[amount_under_loc] money NULL, 
	[maturity_loc] int NULL, 
	[anticipated_partial_repayment_penalties] FLOAT DEFAULT ((0)) NULL,
	[anticipated_partial_repayment_base] SMALLINT DEFAULT ((0)) NOT NULL,
	[anticipated_total_repayment_base] SMALLINT DEFAULT ((0)) NOT NULL,
...
GO
ALTER TABLE [dbo].[SetUp_SageJournal] ADD CONSTRAINT
	PK_SetUp_SageJournal PRIMARY KEY CLUSTERED 
	(
	product_code,
	journal_code
